...
// Type: pwnagebot.GameInterface.Radar.RadarNpc
...
{
  public class RadarNpc : RadarBase
  {
    private Point[] a;

    public RadarNpc(Entity entity_, Entity me_)
      : base(entity_, me_)
    {
      this.m_type = RadarBase.ObjectType.Npc;
    }
    ...
    public override void Refresh()
    {
      ...
      this.a[1].X = this.m_origin.X + num / 2;
      this.a[1].Y = this.m_origin.Y + num / 2;
      this.a[2].X = this.m_origin.X;
